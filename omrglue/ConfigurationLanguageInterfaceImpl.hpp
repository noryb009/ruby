...
public:
	...
	virtual bool initializeSizeClasses(MM_EnvironmentBase* env);
	...
	virtual uintptr_t getEnvPoolNumElements(void);

#define MAXIMUM_RUBY_NUMBER_OF_GC_THREADS 4

	virtual uintptr_t getMaxGCThreadCount(void) { return MAXIMUM_RUBY_NUMBER_OF_GC_THREADS; }
